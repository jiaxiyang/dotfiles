...
#POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(user dir rbenv vcs vi_mode)
#POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status root_indicator background_jobs time)

# Path to your oh-my-zsh installation.
export ZSH="/home/xiyang/.oh-my-zsh"
...
alias em='/usr/bin/emacs26 -nw'
alias gs='git status'
alias hs='hexo clean && hexo g && hexo s'
alias hd='hexo clean && hexo g && hexo d && git add . && git commit -m "update" && git push'
